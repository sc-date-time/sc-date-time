  ...
  <div class="control">
    ...
    <div class="slider"> 
      <div class="date-control">
        <div class="title">
          <button ng-click="calendar._incMonth(-1)" style="float: left;" ng-class="{'visuallyhidden': calendar.isVisibleMonthButton('mindate')}" class="btn btn-link"><i class="material-icons">chevron_left</i></button><span class="month-part">{{date | date:'MMMM'}}
          ...
          <button ng-click="calendar._incMonth(1)" style="float: right;" ng-class="{'visuallyhidden': calendar.isVisibleMonthButton('maxdate')}" class="btn btn-link"><i class="material-icons">chevron_right</i></button>
        </div>
        <div class="headers">
      ...
      <button ng-click="modeSwitch()" class="btn btn-link switch-control"><i class="material-icons">access_time</i><i class="material-icons">date_range</i><span class="visuallyhidden">{{modeSwitchText()}}</span></button>
      <div class="time-control">
        <div class="time-inputs">
          <input type="number" min="{{_hours24 ? 0 : 1}}" max="{{_hours24 ? 23 : 12}}" ng-model="clock._hours"/>
          <button ng-click="clock._incHours(1)" class="btn btn-link hours up"><i class="material-icons">expand_less</i></button>
          <button ng-click="clock._incHours(-1)" class="btn btn-link hours down"><i class="material-icons">expand_more</i></button>
          <input type="number" min="0" max="59" ng-model="clock._minutes"/>
          <button ng-click="clock._incMinutes(1)" class="btn btn-link minutes up"><i class="material-icons">expand_less</i></button>
          <button ng-click="clock._incMinutes(-1)" class="btn btn-link minutes down"><i class="material-icons">expand_more</i></button>
        </div>
