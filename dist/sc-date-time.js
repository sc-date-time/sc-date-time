        ...
        '$scope', 'scDateTimeI18n', function(scope, scDateTimeI18n) {
          ...
          scope.clock = {
            ...
            _incMinutes: function(inc) {
              ...
              this._minutes = scope.addZero(Math.max(0, Math.min(59, parseInt(this._minutes) + inc)).toString());
